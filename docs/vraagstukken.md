...
| **B-04** | PDP-inrichting | S05 | Wordt besluitvorming per bronhouder, gedeeld of hybride ingericht? | Sta meerdere implementatievarianten toe onder één gestandaardiseerd PEP-PDP-koppelvlak en dezelfde beleidseisen. | Bronhouders, FDS/GDI |
...
| **B-11** | Semantische governance | S10 | Wie beheert begrippen, schema's en mappings en hoe worden wijzigingen, versieovergangen en semantische conflicten vastgesteld en afgehandeld? | Domeinen beheren inhoud; FDS beheert profielen, vindbaarheid en interoperabiliteitsregels. | Geonovum, FDS, domeinen, bronhouders |
...
| **B-18** | Terugmelden van fouten of vermoedelijke onjuistheden | S10 | Hoe worden fouten en waarschijnlijke onjuistheden terug gemeld aan de bronhouder? | Nog niet uitgewerkt. NB: Voor OOTS is expliciet besloten geen terugmelding in te richten! | Nog vast te stellen |
| **B-19** | Vertegenwoordiging & bevoegdheidsbewijzen | S04, S05, S09, S10 | Hoe wordt aantoonbaar gemaakt dat een persoon, organisatie of systeem namens een andere partij handelt, welke bevoegdheid daarbij geldt en hoe wordt die informatie betrokken bij de autorisatiebeslissing? | Scheid identiteit, vertegenwoordiging en autorisatie. Ondersteun meerdere betrouwbare bronnen en bewijsvormen via een gemeenschappelijk model en gestandaardiseerde verificatie, zonder afhankelijkheid van één voorziening, leverancier of wallettype. | BZK, GDI/FDS, domeinen, bronhouders en beheerders van relevante vertegenwoordigingsvoorzieningen |
