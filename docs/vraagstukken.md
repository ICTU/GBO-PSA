...
| **B-12** | OOTS-functiegrenzen | S08, S10 | Welke functies liggen in OOTS-V, de OOTS-adapter en de mappingvoorziening? Moeten OOTS-verzoeken altijd via de OOTS-adapter/mappingvoorziening lopen? | De Basisinrichting OOTS verzorgt Europese proces- en transportfuncties. GBO verzorgt de bronkoppeling en eventueel de semantische transformatie. Voor de eenvoud van de inrichting wordt de mappingvoorziening altijd aangeroepen - ook als er geen sprake is van semantische vertaling en de gegevens 1-op-1 doorgegeven worden. | BZK/EZK, bNC-SDG |
