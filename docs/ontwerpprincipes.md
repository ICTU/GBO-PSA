...
| **D-05** | Gegevens bij de bron | GBO creëert geen structureel gegevensmagazijn. Tijdelijke opslag is alleen toegestaan als dit noodzakelijk en rechtmatig is en bewaartermijn, beveiliging en verwijdering zijn vastgelegd. Dit is primair de verantwoordelijkheid van de bronhouder(s) en geen verantwoordelijkheid van GBO. |
...
| **D-12** | Aantoonbare veiligheid | Deelnemers en gedeelde voorzieningen voldoen aantoonbaar aan toepasselijke beveiligingsnormen. Audits, testen, kwetsbaarheidsbeheer (ook SPOF(Single Point of Failure)-analyses) en incidentafhandeling zijn onderdeel van de aansluit- en beheerafspraken. |
